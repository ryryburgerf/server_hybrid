            ...
            avis d'urgence : [
                {
                    ...
                    body : 'Vous pouvez maintenant changer votre niveau et vbucks, en utilisant le bot de notre serveur discord, amusez-vous avec Storm !' ,
                }
            ]
        } ,
    ...
    données . données . battleroyalenewsv2  =  {
        nouvelles : {
            mots : [ {
                ...
                _type : 'CommonUI Simple Message MOTD' ,
                titre : 'Orage' ,
                body : 'Storm n'est pas affilié, associé, autorisé, approuvé par ou officiellement connecté à Epic Games.' ,
                videoLoop : false ,
                ...
                projecteur : faux ,
                URL du site : 'https://discord.gg/stormfn' ,
